...
def collect_airflow(c, output=f"src/{PACKAGE_NAME}/_vendor"):
    ...
    def collect_codes(cls):
        ...
        if name not in scopes[mod]:
            ...
            clsdef = ClassDef(
                ...
                body=body or [Pass()],
                decorator_list=[Name(id="immutable")],
            )
    ...
    for dst_module, items in scopes.items():
        ...
        imports = ImportFrom(module="airfly._ast", names=[alias(name="immutable")])
