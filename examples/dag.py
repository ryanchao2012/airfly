...
with DAG("examples", **dag_kwargs) as dag:
    ...
    group_examples = TaskGroup(group_id="examples", prefix_group_id=False)
    group_examples_bash_operator = TaskGroup(
        group_id="examples.bash_operator",
        prefix_group_id=False,
        parent_group=group_examples,
    )
    group_examples_complex = TaskGroup(
        group_id="examples.complex", prefix_group_id=False, parent_group=group_examples
    )
    group_examples_python_operator = TaskGroup(
        group_id="examples.python_operator",
        prefix_group_id=False,
        parent_group=group_examples,
    )
    group_examples_tutorial = TaskGroup(
        group_id="examples.tutorial", prefix_group_id=False, parent_group=group_examples
    )
    group_examples_bash_operator_workflow = TaskGroup(
        group_id="examples.bash_operator.workflow",
        prefix_group_id=False,
        parent_group=group_examples_bash_operator,
    )
    group_examples_complex_catalog = TaskGroup(
        group_id="examples.complex.catalog",
        prefix_group_id=False,
        parent_group=group_examples_complex,
    )
    group_examples_complex_entry = TaskGroup(
        group_id="examples.complex.entry",
        prefix_group_id=False,
        parent_group=group_examples_complex,
    )
    group_examples_complex_tag = TaskGroup(
        group_id="examples.complex.tag",
        prefix_group_id=False,
        parent_group=group_examples_complex,
    )
    group_examples_python_operator_workflow = TaskGroup(
        group_id="examples.python_operator.workflow",
        prefix_group_id=False,
        parent_group=group_examples_python_operator,
    )
    group_examples_tutorial_demo = TaskGroup(
        group_id="examples.tutorial.demo",
        prefix_group_id=False,
        parent_group=group_examples_tutorial,
    )
    examples_bash_operator_workflow_also_run_this = BashOperator(
        task_id="examples.bash_operator.workflow.also_run_this",
        bash_command='echo "run_id={{ run_id }} | dag_run={{ dag_run }}"',
        task_group=group_examples_bash_operator_workflow,
    )
    examples_bash_operator_workflow_run_this = BashOperator(
        task_id="examples.bash_operator.workflow.run_this",
        bash_command="echo 1",
        task_group=group_examples_bash_operator_workflow,
    )
    ...
    examples_complex_catalog_search_catalog = PythonOperator(
        ...
        task_group=group_examples_complex_catalog,
    )
    ...
    examples_complex_entry_create_entry_gcs = BashOperator(
        ...
        task_group=group_examples_complex_entry,
    )
    ...
    examples_complex_entry_delete_entry = BashOperator(
        task_id="examples.complex.entry.delete_entry",
    ...
    examples_complex_entry_get_entry = BashOperator(
        task_id="examples.complex.entry.get_entry",
    ...
    examples_complex_entry_lookup_entry = BashOperator(
        task_id="examples.complex.entry.lookup_entry",
    ...
    examples_complex_entry_update_entry = BashOperator(
        task_id="examples.complex.entry.update_entry",
        bash_command="echo update_entry",
        task_group=group_examples_complex_entry,
    )
    examples_complex_tag_create_tag = BashOperator(
        task_id="examples.complex.tag.create_tag",
        bash_command="echo create_tag",
        task_group=group_examples_complex_tag,
    )
    ...
    examples_complex_tag_delete_tag = BashOperator(
        task_id="examples.complex.tag.delete_tag",
    ...
    examples_complex_tag_list_tags = BashOperator(
        task_id="examples.complex.tag.list_tags",
    ...
    examples_complex_tag_update_tag = BashOperator(
        task_id="examples.complex.tag.update_tag",
    ...
    examples_python_operator_workflow_run_this = PythonOperator(
        ...
        task_group=group_examples_python_operator_workflow,
    )
